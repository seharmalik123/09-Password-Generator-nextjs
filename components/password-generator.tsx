...
//Import custom UI componens from the UI directory:
import {
    Card,
    CardHeader,
    CardTitle,
...
export default function GeneratePasswordComponent() {
   ...
   const[includeLowercase, setIncludeLowerercase] = useState<boolean>(true); 
   ...
   const[password, setPassword] = useState<string>("");
    ...
    const generatePassword = (): void => {
       ...
       for(let i = 0; i < length; i++) {
        ...
        generatedPassword += allChars[randomIndex]; // Generated password character by character
     }
     ...
     return(
        <div className="flex flex-col items-center justify-center min-h-screen bg-purple-400 dark:bg-gray-900">
            { /*Center the password generator card within the screen */}
            <Card className="w-full max-w-md p-6 bg-violet-300 dark:bg-gray-800 shadow-lg rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                     ...
                     onCheckedChange={handlCheckboxChange(setIncludeUppercase)}
                    />
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        onCheckedChange={handlCheckboxChange(setIncludeLowerercase)}
                        />
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        onCheckedChange={handlCheckboxChange(setIncludeNumbers)}
                        />
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            onCheckedChange={handlCheckboxChange(setIncludeSymbols)}
                            />
                            <Label htmlFor="symbols">Symbols</Label>
                        </div>
                        </div>
                        {/*Button to generate password */}
                        <Button type="button" className="w-full bg-fuchsia-900 rounded-full" onClick={generatePassword}>
                            Generate Password
                        </Button>
                        ...
                        <div className="space-y-2 rounded-2xl">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                className="flex-1"
                                />
                                <Button type="button" className="bg-fuchsia-700 rounded-full" onClick={copyToClipboard}>
                                    Copy to Clipboard
                                </Button>
                            </div>
                        </div>
